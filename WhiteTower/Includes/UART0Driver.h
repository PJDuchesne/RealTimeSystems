...
#define UART0_FR_R          (*((volatile unsigned long *)0x4000C018))   // UART0 Flag Register (UNUSED)
...
#define UART0_IFLS_R        (*((volatile unsigned long *)0x4000C034))   // UART0 Interrupt FIFO Level Select Register (UNUSED)
...
#define UART0_CC_R          (*((volatile unsigned long *)0x4000CFC8))   // UART0 Clock Control Register (UNUSED)

#define UART_FR_TXFF            0x00000020  // UART Transmit FIFO Full (UNUSED)
#define UART_FR_RXFE            0x00000010  // UART Receive FIFO Empty (UNUSED)
#define UART_RX_FIFO_ONE_EIGHT  0x00000038  // UART Receive FIFO Interrupt Level at >= 1/8 (UNUSED)
#define UART_TX_FIFO_SVN_EIGHT  0x00000007  // UART Transmit FIFO Interrupt Level at <= 7/8 (UNUSED)
#define UART_LCRH_WLEN_8        0x00000060  // 8 bit word length
#define UART_LCRH_FEN           0x00000010  // UART Enable FIFOs (UNUSED) 
#define UART_CTL_UARTEN         0x00000301  // UART RX/TX Enable
#define UART_INT_TX             0x020       // Transmit Interrupt Mask
#define UART_INT_RX             0x010       // Receive Interrupt Mask
#define UART_INT_RT             0x040       // Receive Timeout Interrupt Mask (UNUSED)
#define UART_CTL_EOT            0x00000010  // UART End of Transmission Enable (UNUSED)
#define EN_RX_PA0               0x00000001  // Enable Receive Function on PA0 (UNUSED)
#define EN_TX_PA1               0x00000002  // Enable Transmit Function on PA1 (UNUSED)
